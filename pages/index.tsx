...
<MainLayout>
      <div className="flex flex-col min-h-screen">
          ...
          {/* Main Content */}
        <main className="flex-grow py-150px bg-[url('/images/bg-image-1.png')] justify-center items-center px-4 py-4 max-w-6xlmx-auto text-center rounded-lg shadow-md">
          {/* Welcome Heading */}
          <h1 className="text-4xl font-extrabold text-gray-900 mb-4">
            Welcome to S&G Fast and Easy Buy
          </h1>
          <h2 className="text-xl font-medium text-gray-900 mb-8 py-3rem">
          ...
          <div className="flex justify-center gap-10 mb-10 py-3rem">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-900 font-bold">Easy Shopping</p>
            </div>
            <div className="flex flex-col items-center">
              <Package className="w-12 h-12 text-blue-500 mb-2" />
              <p className="text-gray-900 font-bold">Fast Delivery</p>
            </div>
            <div className="flex flex-col items-center">
              <Star className="w-12 h-12 text-yellow-500 mb-2" />
              <p className="text-gray-900 font-bold">Top Quality</p>
            </div>
          </div>
